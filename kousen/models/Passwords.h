...
class Passwords
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,std::string>;//UserID,digest
     ...
     */
    explicit Passwords(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Passwords(const Json::Value &pJson) noexcept(false);
     ...
     */
    Passwords(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Passwords>;
    friend drogon::orm::BaseBuilder<Passwords, true, true>;
    friend drogon::orm::BaseBuilder<Passwords, true, false>;
    friend drogon::orm::BaseBuilder<Passwords, false, true>;
    friend drogon::orm::BaseBuilder<Passwords, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Passwords>;
#endif
    ...
    std::shared_ptr<std::string> digest_;
    struct MetaData
    {
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where UserID = $1 and digest = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where UserID = $1 and digest = $2";
        return sql;
    }
